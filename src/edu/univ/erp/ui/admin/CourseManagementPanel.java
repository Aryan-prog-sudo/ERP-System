 ...
 * UPDATED: Now calls AdminService to create courses.
 */
public class CourseManagementPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        createButton.addActionListener(e -> onCreateCourse()); // This calls the updated method
    ...
    private void onCreateCourse() {
        ...
        if (success) {
            tableModel.addRow(new Object[]{code, title, creditsStr});
            codeField.setText("");
            titleField.setText("");
